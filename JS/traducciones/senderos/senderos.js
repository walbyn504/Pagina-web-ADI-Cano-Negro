...
window.translations.senderos = {
    ...
    en: {
        ...
        senderos_info_subtitle: "Before starting your journey, consider some recommendations for a safe, conscious, and nature-friendly experience.",

        senderos_box1_title: "Recommendations",
        senderos_box1_desc: "Wear comfortable shoes, bring water, sunscreen, and appropriate clothing for walking in a natural environment.",

        senderos_box2_title: "Conservation",
        senderos_box2_desc: "Respect flora and fauna, do not leave waste, and help protect the ecosystem balance.",
